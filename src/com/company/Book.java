...
public class Book {
    ...
    public boolean equals(Object o) {
        ...
        Book book = (Book) o;
        return yearOfPublish == book.yearOfPublish && nameOfBook.equals(book.nameOfBook) && author.equals(book.author);
    }

    @Override
    public int hashCode() {
        return Objects.hash(nameOfBook, yearOfPublish, author);
    }
}
